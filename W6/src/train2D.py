...
from datasets.HMDB51Dataset2D import HMDB51Dataset
...
def train(
    ...
    for batch in pbar:
        ...
        batch_frames, labels = batch['clips'], batch['labels'].to(device)
        # Compute loss

        outputs = model(batch_frames.to(device))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--temporal-info', action='store_true', default=False,
                        help='Use temporal information in the model')
    ...
    datasets = create_datasets(
        ...
        temporal_info=args.temporal_info
    )
