...
def init():
    ...
    parser.add_argument('--color', action='store_true', default=False, help='Whether to use color for the binary frames computation')
    ...
    parser.add_argument('--state-of-the-art', action='store_true', default=False, help="State of the art background subtraction method")
